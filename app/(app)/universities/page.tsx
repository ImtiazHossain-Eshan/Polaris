/**
 * /universities — premium university discovery + fit engine. Plan-gated to
 * Pro+. Merges the KB rows with the admissions enrichment dataset (official
 * links, application systems, deadline patterns, test policy, tuition, aid,
 * sources) and hands the full profiles to the client, which renders the 3D
 * card grid, filters, detail modal, comparison, and the live fit bands
 * computed from the student's real profile inputs.
 */
